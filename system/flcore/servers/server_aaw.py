...
class FedAAW(Server):
    ...
    def train(self):
        ...
        for i in range(self.global_rounds+1):
            s_t = time.time()
            print("*************************** 2.server_Fed_AAW select_clients ***************************\n")
            ...
            print("*************************** 4.server_Fed_AAW send_models,client.local_initialization ***************************\n")
            #发送模型信息
            self.send_models(i)
            ...
            print("*************************** 5.server_Fed_AAW selected_clients ,train（）***************************\n")
            for client in self.selected_clients:
                client.train()
            #参与客户端训练本地数据
            # -------------------------------------------------------------------------
            ...
            #
            #     client.train()
            #     client.calculate_local_loss(False)
        ...
        #-------------------------------------------------------------------
            ...
            print(
                "*************************** 6.server_Fed_AAW adpativeweight ,client.local_initialization***************************\n")
            #自适应更新权重
            self.adpativeweight()
            ...
            print(
                "*************************** 7.server_Fed_AAW receive_models ***************************\n")

            print("\n Fed_AAW receive_models")
            #将发送模型参数
        ...
        print("train aggregation error is ：", self.aggreErr)
        ...
        if self.num_new_clients > 0:
            ...
            self.set_new_clients(client_AAW)
            print(f"\n-------------Fine tuning round-------------")
    ...
    def setdistance(self):
        ...
        for client in self.clients:
           ...
           # print(f"INFormation-------------serverjs----------------------init client {client.id} JS distance is {client.distance}-------------------------------")
