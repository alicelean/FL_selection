...
from flcore.servers.server_center import Center
#rom flcore.servers.server_moonaaw import MOONAAW
...
def run(args):
    ...
    for i in range(args.prev, args.times):
        ...
        elif args.algorithm == "Center":
            server = Center(args, i)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--is_even_avg', type=bool, default=False)
