...
from flcore.clients.client_RL import clientRL
...
from anetwork import FeedAtteniion
...
class FedRL(Server):
    ...
    def __init__(self, args, times):
        ...
        self.env = FederatedLearningEnv(num_clients=args.num_clients, k=self.num_join_clients,feature=6)
        ...
        self.ppomodel = PPO(policy_class=FeedAtteniion, env=self.env, **self.hyperparameters)
...
#-------------------------------------------
    ...
    #         print("client id state  :",client.currentloss, client.size, client.stale, client.age,client.last_select,client,sleect_time)
    #         client.states = [client.currentloss, client.size, client.stale, client.age,client.last_select,client,sleect_time]
    ...
    def get_client_states(self):
        clientStates=[]
        #增加一些指标,client.last_select,client.select_time
        for c in self.clients:
            c.states=[c.currentloss,c.size,c.stale,c.age,c.last_select,c.select_time]
